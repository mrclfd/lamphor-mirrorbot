...
# Redesigned By - @bipuldey19 (https://github.com/mrclfd/lamphor-mirrorbot/commit/1e572f4fa3625ecceb953ce6d3e7cf7334a4d542#diff-c3d91f56f4c5d8b5af3d856d15a76bd5f00aa38d712691b91501734940761bdd)
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/d6e468c2e2218b1e5f4b5.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/d6e468c2e2218b1e5f4b5.jpg"
          alt="logo"
        />
        <a href="https://t.me/LamphorMirrorGroup"> 
          <h2 class="name">lamphor-mirrorbot</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/mrclfd/lamphor-mirrorbot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/LamphorMirrorUpdates"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/LamphorMirrorUpdates">
          <h2 class="name">lamphor-mirrorbot</h2>
        </a>
      </div>
      <div class="social">
...
@routes.get('/lamphor/files/{hash_id}')
async def list_torrent_contents(request):
    ...
    if "pin_code" not in gets.keys():
        rend_page = code_page.replace("{form_url}", f"/lamphor/files/{torr}")
    ...
    rend_page = rend_page.replace(
        "{form_url}", f"/lamphor/files/{torr}?pin_code={pincode}")
    client.auth_log_out()
    return web.Response(text=rend_page, content_type='text/html')
...
@routes.post('/lamphor/files/{hash_id}')
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See lamphor-mirrorbot <a href='https://github.com/mrclfd/lamphor-mirrorbot'>@GitHub</a> By <a href='https://github.com/mrclfd'>Marcel Faraday</a></h1>", content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>lamphor-mirrorbot</h3>", content_type="text/html")
            return response
