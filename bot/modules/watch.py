...
def _watch(bot: Bot, update, isTar=False, isZip=False):
    ...
    try:
        ...
        msg += f"\n\nExample:\n<code>/{BotCommands.WatchCommand} https://youtu.be/-8M-d6uXXpI 1080|Sawang Sinawang</code>\n\n"
        msg += "This file will be downloaded in 1080p quality and it's name will be <b>Sawang Sinawang</b>"
