...
def start(update, context):
    ...
    buttons.buildbutton("Channel", "https://t.me/lamphorStuff")
    buttons.buildbutton("Group", "https://t.me/LamphorMirrorGroup")
...
'''
        ...
        sendMarkup(
            'Oops! not a Authorized user.\nPlease deploy your own <b>lamphor-mirrorbot</b>.',
            context.bot,
            update,
            reply_markup,
        )
